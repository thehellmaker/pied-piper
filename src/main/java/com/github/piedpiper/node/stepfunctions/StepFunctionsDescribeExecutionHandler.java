...
public class StepFunctionsDescribeExecutionHandler implements Function<NodeInput, NodeOutput> {
	...
	@Inject
	public StepFunctionsDescribeExecutionHandler(AWSStepFunctions stepFunctionsClient) {
